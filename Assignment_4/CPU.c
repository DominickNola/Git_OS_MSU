...
// When stuck, I worked with John Shapiro.
...
void process_done (int signum) {
    ...
    if(running->pid != idle.pid) {
        ...
        WRITESTRING ("Running Process pid: ");
        ...
        WRITESTRING("\nProcessing Time: ");
        WRITEINT(time(NULL) - running->started, 3);
        WRITESTRING(" seconds\n");
        ...
        WRITESTRING("FINAL IDLE UNTIL EXECUTION TIME LIMIT REACHED........\n")
    }
